...
public class Spinner_adapter extends ArrayAdapter<Getbusline> {

    public Spinner_adapter(Context context, List<Getbusline> getbuslines) {
        super(context,0,getbuslines);
    }
