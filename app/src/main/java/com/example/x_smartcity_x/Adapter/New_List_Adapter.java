...
public class New_List_Adapter extends RecyclerView.Adapter<New_List_Adapter.ViewHolder> {
    ...
    public New_List_Adapter(List<GetNewsAll> allList) {
        this.getNewsAlls = allList;
    }
